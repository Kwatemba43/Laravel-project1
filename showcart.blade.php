...
@endforeach
    ...
    <div align="center" style="padding: 10px;">
        ...
        <button style="color:green;" class="btn btn-primary" type="button" id="order">Order Now</button>
...
<div id ="appear" align="center" style="padding: 10px; display: none;">
    ...
    <div style="padding: 10px;">
        ...
        <button  style="color:green;" id="close" type="button" class="btn btn-danger">Close</button>
